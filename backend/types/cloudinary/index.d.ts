...
declare module 'cloudinary' {
  ...
  type ImageFormat =
    ...
    | 'tga'
    | 'heic';
  type VideoFormat = string | 'auto' | 'flv' | 'm3u8' | 'ts' | 'mov' | 'mkv' | 'mp4' | 'mpd' | 'ogv' | 'webm';
  ...
  export namespace v2 {
    ...
    namespace api {
      function create_streaming_profile(
        name: string,
        options: AdminApiOptions | { display_name?: string; representations: TransformationOptions },
      ...
      function create_upload_preset(
        options?: AdminApiOptions | { name?: string; unsigned?: boolean; disallow_public_id?: boolean },
        callback?: ResponseCallback
      ): Promise<any>;
      ...
      function update_streaming_profile(
        name: string,
        options: { display_name?: string; representations: Array<{ transformation?: VideoTransformationOptions }> },
        callback?: ResponseCallback
      ): Promise<any>;
